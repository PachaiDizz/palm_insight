...
export default function PwaInstallBanner() {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 md:left-auto md:right-4 md:w-96 animate-slide-up">
      <div className="bg-[#0f1a0f] border border-emerald-600/30 rounded-2xl p-5 shadow-2xl shadow-black/50">
        <div className="flex items-start gap-3 mb-4">
          <span className="text-2xl">🌿</span>
          <div>
            <h3 className="text-white font-bold text-sm">PalmInsight</h3>
