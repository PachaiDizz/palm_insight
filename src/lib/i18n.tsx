...
const translations = {
  en: {
    ...
    "nav.map": "Map",
    "map.title": "Field Map",
    "map.subtitle": "Monitor team working locations in real-time",
    "map.allBlocks": "All Blocks",
    "map.today": "Today",
    "map.allTeams": "All Teams",
    "map.teamList": "Team List",
    "map.noLocation": "No location data",
    "map.noEntries": "No entries with coordinates for this period",
    "map.workTeams": "Work Teams",
    "map.noWorkTeams": "No Work",
    "map.location": "Location",
    "map.enterCoords": "Enter the GPS coordinates of today's working lot",
    "map.latitude": "Latitude",
    "map.longitude": "Longitude",
    "map.lotLabel": "Lot Label",
    "map.lotLabelPlaceholder": "e.g. Lot 3A",
    "map.locationOptional": "LOCATION (OPTIONAL)",
    "map.useMyLocation": "Use My Location",
    "map.flyTo": "Show on Map",
  },
  ms: {
    // Navigation
    ...
    // Map
    "nav.map": "Peta",
    "map.title": "Peta Lapangan",
    "map.subtitle": "Pantau lokasi kerja pasukan secara masa nyata",
    "map.allBlocks": "Semua Blok",
    "map.today": "Hari Ini",
    "map.allTeams": "Semua Pasukan",
    "map.teamList": "Senarai Pasukan",
    "map.noLocation": "Tiada data lokasi",
    "map.noEntries": "Tiada entri dengan koordinat untuk tempoh ini",
    "map.workTeams": "Pasukan Bekerja",
    "map.noWorkTeams": "Tidak Bekerja",
    "map.location": "Lokasi",
    "map.enterCoords": "Masukkan koordinat GPS lot kerja hari ini",
    "map.latitude": "Latitud",
    "map.longitude": "Longitud",
    "map.lotLabel": "Label Lot",
    "map.lotLabelPlaceholder": "cth. Lot 3A",
    "map.locationOptional": "LOKASI (PILIHAN)",
    "map.useMyLocation": "Gunakan Lokasi Saya",
    "map.flyTo": "Tunjukkan di Peta",
  },
} as const;
